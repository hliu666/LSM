...
class TBM_Pars:
    def __init__(self, pars):
        ...
        self.clspan = 1.001  # clspan, leaf lifespan               (1.0001 - 5)
        ...
        self.f_roo = 0.457  # f_roo, frac GPP to fine roots    (0.01 - 0.5)
        self.f_lab = 0.48  # f_lab, frac GPP to clab           (0.01 - 0.5)
        ...
        """
        self.CI_thres = 0.72  # clumping index
        ...
        self.RUB = pars[0]  # [umol sites m-2] Rubisco density
        self.Rdsc = 0.01   # [] Scalar for mitochondrial (dark) respiration
        self.CB6F = pars[1]  # [umol sites m-2] Cyt b6f density
        self.gm = 0.01  # [] mesophyll conductance to CO2
        self.e = 0.92

        # 2. Initial values of constants
        self.BallBerrySlope = 10.0
        self.BallBerry0 = pars[2]  # intercept of Ball-Berry stomatal conductance model
