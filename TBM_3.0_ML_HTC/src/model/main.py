...
from spectral import resample_hyperspectral
...
def main():
    ...
    output_dim1, output_dim2, output_dim3 = 8, 21, 2101
    ...
    for j in range(0, js):
        ...
        model_output_daily, model_output_hourly, model_output_spectral = m.mod_list(output_dim1, output_dim2, output_dim3)
        ...
        joblib.dump(resample_hyperspectral(model_output_spectral), "{0}_model_output_spectral.pkl".format(k), compress=3)
