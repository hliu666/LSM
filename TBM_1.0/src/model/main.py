...
d = dc.DalecData(2019, 2022, site, ci_flag, 'nee')
m = mc.DalecModel(d)
model_output, nee_y, sif_y = m.mod_list(d.xb)
...
joblib.dump(Re_y,  "../../data/output/model/Re_ci{0}_{1}.pkl".format(ci_flag, site))
joblib.dump(brf_y,  "../../data/output/model/brf_ci{0}_{1}.pkl".format(ci_flag, site))
joblib.dump(apar_y,  "../../data/output/model/apar_ci{0}_{1}.pkl".format(ci_flag, site))
joblib.dump(par_y,  "../../data/output/model/par_ci{0}_{1}.pkl".format(ci_flag, site))
...
"""
joblib.dump(sif_y,  "../../data/output/model/SIF_ci{0}_{1}.pkl".format(ci_flag, site))
