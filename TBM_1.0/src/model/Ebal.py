...
def Ebal(dC, x, lai, ebal_rtm_pars, k_pars):    
    ...
    while CONT:                          # while energy balance does not close
        rad_Rnuc, rad_Rnhc, APARu, APARh, PAR, rad_Rnus, rad_Rnhs, Fc, Fs, i0, iD = calc_netrad(dC, x, lai, L, T_Pars, net_rads, ebal_rtm_pars, ebal_sunsha_pars)
    ...
    return Ccu, Cch, Tcu, Tch, ecu, ech, APARu, APARh, PAR, Esolars, LST, Fc
