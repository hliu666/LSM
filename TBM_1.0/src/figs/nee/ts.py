...
for i in range(0, 2):
    ...
    if i == 0:    
        ...
        axs[i].text(dates[-1]-400, 10, "R\u00B2={0} MAE={1}".format(round(r*r, 2), round(mae, 2)), fontsize=ftsize*1.2)                              
        ...
        axs[i].text(dates[-1]-5.5, 15, "R\u00B2={0} MAE={1}".format(round(r*r, 2), round(mae, 2)), fontsize=ftsize*1.2)                              
