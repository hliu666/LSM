...
subplt.text(date[70], 34, "R\u00B2={0},MAE={1}".format(round(r*r, 2), round(mae, 2)), fontsize=ftsize*1.3)                              
...
plt.ylabel("LST (degree)", fontsize=ftsize*1.5, family = ftfamily, labelpad=15)  
#fig.tight_layout() 
...
fig.subplots_adjust(left = None, right = None, bottom = 0.32)
