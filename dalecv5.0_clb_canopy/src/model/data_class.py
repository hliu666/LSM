...
class DalecData:
    ...
    def __init__(self, start_yr, end_yr, site, ci_flag, pars):
        ...
        model_output = np.genfromtxt('../../data/driving/model_output.csv', delimiter=',')
        self.lai = model_output[:,-2]
        self.sai = model_output[:,-1]
        ...
        self.p11 = 0.41  # f_lab, frac GPP to clab           (0.01 - 0.5)
        ...
        self.p15 = 60  # Vcmax25
        self.p16 = pars[0] # clumping index 
        self.p17 = pars[1]
        self.p18 = np.inf
