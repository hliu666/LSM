...
for season in seasons:
    ...
    s1 = joblib.load("sensitivity_nee_{0}.pkl".format(season))
    s2 = joblib.load("sensitivity_fpar_{0}.pkl".format(season))
    s3 = joblib.load("sensitivity_lai_{0}.pkl".format(season))
    s4 = joblib.load("sensitivity_lst_{0}.pkl".format(season))
    s5 = joblib.load("sensitivity_red_{0}.pkl".format(season))
    s6 = joblib.load("sensitivity_nir_{0}.pkl".format(season))
    ...
    plot_path = "C:/Users/liuha/Desktop/dalecv4.4/figs/sa/hist_{0}.jpg".format(season)
    plt.show()
