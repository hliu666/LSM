...
plt.figure(figsize=(12,4))
plt.title('LST')
plt.scatter((d.lst_data["year"]-2019)*365+d.lst_data["doy"], d.lst_data["LST_Day_1km"], color = 'r', alpha=0.5)
plt.scatter((d.lst_data["year"]-2019)*365+d.lst_data["doy"], lst_y[d.index], color = 'b', alpha=0.5)
