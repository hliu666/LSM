...
def rtm_o(dC, x, lai, hemi_dif_brf):
    ...
    SIF 
    """
    canopy_pars = [i0, iD, p, rho2, rho_hemi, tv, kc, kg]
    hemi_brf = [sob_vsla,          sof_vsla,          kgd]
    dif_brf  = [sob_vsla_dif,      sof_vsla_dif,      kg_dif] 
    
    return ebal_pars, k_pars, BRF, canopy_pars, hemi_brf, dif_brf, fPAR
