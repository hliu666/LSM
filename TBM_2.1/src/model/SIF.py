...
def creat_sif_matrix(Cab, Cm, Kab, Kall):
    Kall = Kall.reshape(-1,1)
    X_Cm = Cm
    
    #phi  = scipy.io.loadmat('phi.mat')['phi'][240:451]
    phiI  = scipy.io.loadmat('phiI.mat')['phiI'][240:451]
    phiII = scipy.io.loadmat('phiII.mat')['phiII'][240:451]
    ...
    #M    = sip_cx(Kall_cx, Kab_cx, Cm, Cab, phi, wle, wlf)
...
def cal_sif_leaf(fqe_pars, MII, MI, W_diag, Mf_diag, pL, q):
...
def cal_canopy_sif(dC, x, Esolar, M_pars, canopy_pars, hemi_pars, dif_pars, hemi_dif_pars):
    ...
    dC.MfII_diag[240:451, 0:351] = Mf2
    dC.MbII_diag[240:451, 0:351] = Mb2
    
    dC.MfI_diag[240:451, 0:351] = Mf1
    dC.MbI_diag[240:451, 0:351] = Mb1
    
    dC.MII_diag  = dC.wleaf_diag + dC.MfII_diag + dC.MbII_diag
    dC.MI_diag   = dC.wleaf_diag + dC.MfI_diag  + dC.MbI_diag
    ...
    Qfdir_II, Qfhemi_II, Qfyld_II = cal_rtm_sif(MIIs, MsysII, fs_II, Esolar, leaf, soil, canopy_pars, dir_pars, hemi_pars, dif_pars, hemi_dif_pars)
    Qfdir_I,  Qfhemi_I,  Qfyld_I  = cal_rtm_sif(MIs,  MsysI,  fs_I,  Esolar, leaf, soil, canopy_pars, dir_pars, hemi_pars, dif_pars, hemi_dif_pars)
    Qfdir_A,  Qfhemi_A,  Qfyld_A  = cal_rtm_sif(MAs,  MsysA,  fs_A,  Esolar, leaf, soil, canopy_pars, dir_pars, hemi_pars, dif_pars, hemi_dif_pars)
