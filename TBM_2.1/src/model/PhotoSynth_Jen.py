...
def PhotoSynth_Jen(meteo):
    ...
    Vcmax = sf * peaked_arrh(RUB, Eav, T, deltaSv, Hdv)        
    ...
    A_Pars  = [Vcmax, Km, JP700_j, nl, nc, Gamma_star, Rd]  
    Cm_Pars = [gm, Cs, RH, minCi, BallBerrySlope, BallBerry0, ppm2bar]  
