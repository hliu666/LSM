...
class DalecData:
    ...
    def __init__(self, start_yr, end_yr, site, ci_flag, ob_str=None):
        ...
        self.p1 = 0.69      # f_auto, fraction of GPP respired  (0.3 - 0.7)
        self.p2 = 0.15      # f_fol, frac GPP to foliage        (0.01 - 0.5)
        self.p3 = 0.66      # f_roo, frac GPP to fine roots    (0.01 - 0.5)
        self.p4 = 5         # clspan, leaf lifespan               (1.0001 - 5)
        ...
        self.p7 = 0.02   # theta_lit, litter C turnover     (1e-4 - 1e-2) day-1
        self.p8 = 0.005  # theta_som, SOM C turnover       (1e-7 - 1e-3) day-1
        self.p9 = 0.19     # Theta, temp dependence exp fact (0.018 - 0.08)
        self.p10 = 100      # d_onset, clab release date       (1 - 365) (60,150)
        self.p11 = 0.19     # f_lab, frac GPP to clab           (0.01 - 0.5)
        self.p12 = 100      # cronset, clab release period      (10 - 100)
        self.p13 = 300      # d_fall, date of leaf fall        (1 - 365) (242,332)
        self.p14 = 80      # crfall, leaf fall period          (10 - 100)
        ...
        self.MII, self.MI, self.W_diag, self.Mf_diag, self.pL, self.q  = creat_sif_matrix(self.Cab[0,0], self.Cm[0,0], self.Kab, self.Kall[:,0])
