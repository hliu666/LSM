...
def calc_sf(Soil, sm_top, through_fall, ET):
    ...
    if sm_top < a:
        ...
        sf = 1-2*((sm_top-a)/(b-a))**2
    else:
        sf = 1 
        
    return sm_top, sf

def calc_fwet(w_can, precip, lai, Ev):
    """
    Parameters
    ----------
    w_can : float
    ...
    through_fall : float
        water throughfall into soil layer
    """
    ...
    return w_can, fwet, through_fall