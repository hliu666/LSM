...
for i in range(0, 6):
    ...
    if n == 0 and m == 0:
        axs[m, n].text(date[10],  0.25, "R\u00B2={0}, MAE={1}".format(round(r*r, 2), round(mae, 2)), fontsize=ftsize*1.3)                              
    elif n == 1 and m == 0:
        axs[m, n].text(date[10],  0.91, "R\u00B2={0}, MAE={1}".format(round(r*r, 2), round(mae, 2)), fontsize=ftsize*1.3)                              
    elif m == 1 and n == 0:
        axs[m, n].text(date[10],  0.95, "R\u00B2={0}, MAE={1}".format(round(r*r, 2), round(mae, 2)), fontsize=ftsize*1.3)                              
    else:
        axs[m, n].text(date[10],  0.5, "R\u00B2={0}, MAE={1}".format(round(r*r, 2), round(mae, 2)), fontsize=ftsize*1.3)                              
