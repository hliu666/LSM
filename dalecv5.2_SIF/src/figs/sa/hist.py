...
for mean, err, ylabel, ax in zip([mean1, mean2], [err1, err2], ['fPAR', 'NEE'], [axs[0], axs[1]]):
    ...
    if ax == axs[1]:
        ax.set_xlabel('Leaf traits', fontsize = ftsize/1.5, family=ftfamily)
