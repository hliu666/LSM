...
class DalecData:
    ...
    def __init__(self, start_yr, end_yr, site, ci_flag, ob_str=None):
        ...
        self.Cca    = np.full((1, 365+366+365), 17.8)
        self.N      = np.full((1, 365+366+365), 2.7)
        ...
        self.fhemi_pars  = sif_leaf(self.Cab[0,0], self.Cm[0,0], self.Kab, self.Kall[:,0])
